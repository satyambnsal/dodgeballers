...
export class LoadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("watchtower", "img/watchtower_Lvl1.png");
        this.load.image("propeller", "img/propeller.png");
        this.load.image("watchtower-red", "img/watchtower_Lvl1_red.png");
        this.load.image("watchtower-hill", "img/watchtower_Lvl2.png");
        this.load.image("watchtower-bw", "img/watchtower_Lvl1-bw.png");
        this.load.image("watchtower-hill-bw", "img/watchtower_Lvl2-bw.png");
        ...
        this.load.image("help-page", "img/help_page_4.png");
