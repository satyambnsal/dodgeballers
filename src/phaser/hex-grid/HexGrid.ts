                ...
                if (this.grid.has(r, c)) {
                    ...
                    if (
                        ...
                        (this.grid.get(r, c - 1)?.hexType === h.hexType ||
                            (h.hexType === 4 &&
                                this.grid.get(r, c - 1)?.hexType === 3) ||
                            (h.hexType === 3 &&
                                this.grid.get(r, c - 1)?.hexType === 4))
                    )
                    ...
                    if (
                        ...
                        (this.grid.get(r + 1, c - 1)?.hexType === h.hexType ||
                            (h.hexType === 4 &&
                                this.grid.get(r + 1, c - 1)?.hexType === 3) ||
                            (h.hexType === 3 &&
                                this.grid.get(r + 1, c - 1)?.hexType === 4))
                    )
                    ...
                    if (
                        ...
                        (this.grid.get(r + 1, c)?.hexType === h.hexType ||
                            (h.hexType === 4 &&
                                this.grid.get(r + 1, c)?.hexType === 3) ||
                            (h.hexType === 3 &&
                                this.grid.get(r + 1, c)?.hexType === 4))
                    )
